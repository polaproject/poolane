...
export default async function StaffMessagesPage() {
  ...
  try {
    ...
    await logError({ context: 'staff.messages.page', message: 'Failed to load conversations', error, userId: user.id })
    withUnread = []
  }
  ...
  return (
    <div className="p-4 md:p-6 h-full flex flex-col">
      <div className="mb-4">
        ...
        <p className="text-sm text-foreground/55 mt-0.5">Hội thoại của bạn</p>
      </div>
